...
export default {
    ...
    data: function () {
      return {
          api:[
            {id:1, name:"PT. Customer 1", description: 'This is Customer 1st'},
            {id:2, name:"PT. Customer 2", description: 'This is Customer 2nd'},
            {id:3, name:"PT. Customer 3", description: 'This is Customer 3th'},
    ...
    created(){
        this.$route.meta.title = 'References - Customers'

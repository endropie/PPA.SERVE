    ...
    <div class="card card-default" style="min-height:360px;min-width:420px">
        <div class="card-header" >
            ...
            <div class="float-right">
                <!-- Code -->
                <v-btn @click="$router.push(`${SPA.resources.uri}/create`)" color="success"> New </v-btn>
            </div>
        </div>
        <div class="card-body" >
...
export default {
    ...
    data: function () {
      return {
          api:[
            {id:1, name:"Marketplace one",   description: 'this is marketplace 1st'},
            {id:2, name:"Marketplace two",   description: 'this is marketplace 2nd'},
            {id:3, name:"Marketplace three", description: 'this is marketplace 3th'},
            {id:4, name:"Marketplace three", description: 'this is marketplace 3th'},
            {id:5, name:"Marketplace three", description: 'this is marketplace 3th'},
            {id:6, name:"Marketplace three", description: 'this is marketplace 3th'},
    ...
    created(){
        ...
        this.SPA.resources.api = '/api/v1/references/marketplaces'
        this.SPA.resources.uri = '/admin/references/marketplaces'

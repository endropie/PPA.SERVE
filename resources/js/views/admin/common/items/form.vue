        ...
        <v-form ref="mainForm" v-model="valid" lazy-validation>
          <v-layout row>
            <v-flex sm4>
                <v-layout row>
                <v-flex xs12>
                    <v-text-field label="No. Intern" v-model="rsForm.number" :rules="ruleset('required', 'Intern number')" ></v-text-field>
                </v-flex>
                <v-flex xs12>
                    <v-text-field label="No. Part" v-model="rsForm.part_number" :rules="ruleset('required', 'Part Number')" ></v-text-field>
                </v-flex>
                <v-flex xs12>
                    <v-text-field label="Part MTR" v-model="rsForm.part_mtr" :rules="ruleset('required', 'Name MTR')" ></v-text-field>
                </v-flex>
                <v-flex xs12>
                    <v-text-field label="Part FG" v-model="rsForm.part_fg" :rules="ruleset('required', 'Name FG')" ></v-text-field>
                </v-flex>
                </v-layout>
            </v-flex>
            <v-flex sm8>
            ...
            <v-flex  xs12>
                <table class="table table-sm">
                    ...
                    <tbody>
                        <tr v-for="(pre_production, index) in rsForm.pre_productions" :key="index">
                            ...
                            <td >
                                <v-autocomplete v-model="rsForm.pre_productions[index]" :items="optionData.productions" label="Select a pre-production" class="pt-0"
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.optionData.productions = [
                {id:1, pre_production:"Pre 1st", sa_treatment: "Treatment 1st"},
                {id:2, pre_production:"Pre 2st", sa_treatment: "Treatment 2st"},
                {id:3, pre_production:"Pre 3st", sa_treatment: "Treatment 3st"},
            ];

...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$route.meta.title     = 'References - Marketplaces'
            if(this.$route.meta.mode == 'edit'){
                this.SPA.form.title     = 'Edit Marketplace #' + this.$route.params.id
            }else{
                this.SPA.form.title     = 'New Marketplace'
            }            
        },

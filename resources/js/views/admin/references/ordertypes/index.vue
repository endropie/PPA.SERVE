...
export default {
    ...
    data: function () {
      return {
          api:[
            {id:1, name:"Order type one",   description: 'this is order type 1st'},
            {id:2, name:"Order type two",   description: 'this is order type 2nd'},
            {id:3, name:"Order type three", description: 'this is order type 3th'},
            {id:4, name:"Order type three", description: 'this is order type 3th'},
            {id:5, name:"Order type three", description: 'this is order type 3th'},
            {id:6, name:"Order type three", description: 'this is order type 3th'},
    ...
    created(){
        ...
        this.SPA.resources.api = '/api/v1/references/ordertypes'
        this.SPA.resources.uri = '/admin/references/ordertypes'
